<?php 
// code for comment
if ( ! function_exists( 'enigma_parallax_comment' ) ) :
function enigma_parallax_comment( $comment, $args, $depth ) 
{
	//get theme data
	global $comment_data;
	//translations
	$leave_reply = $comment_data['translation_reply_to_coment'] ? $comment_data['translation_reply_to_coment'] : 
	__('Reply','enigma-parallax'); ?>
    <div class="media enigma_comment_box">
            ...
            <div class="media-body">
				...
				<?php endif; ?>
				<?php esc_html_e('at','enigma-parallax');?>&nbsp;<?php esc_html(comment_time('g:i a')); ?></span>
				...
				<em class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.', 'enigma-parallax' ); ?></em>
				<br/>
				<?php endif; ?>
				</div>
			</div>							

...
<div class="enigma_footer_area">
	<div class="container">
		<div class="col-md-12">
		<?php if ( enigma_parallax_theme_is_companion_active() ) { ?>
            <p class="enigma_footer_copyright_info wl_rtl">
                <?php 
                $enigma_footer_customization = get_theme_mod( 'footer_customizations', __('&copy; Copyright 2020. All Rights Reserved','enigma-parallax') );
                $developed_by_text = get_theme_mod('developed_by_text', __('Powered By','enigma-parallax'));
        ...
        <?php 
            ...
            <p class="enigma_footer_copyright_info wl_rtl">
                <?php esc_html_e('&copy; Copyright 2020. All Rights Reserved','enigma-parallax'); ?>
            </p>    
        <?php
        }

	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Enigma_Customize_btn_Section_Pro(
				...
				'enigma',
				array(
					'title'    => esc_html__( 'Know More about Enigma', 'enigma-parallax' ),
					'pro_text' => esc_html__( 'Upgrade To Pro',         'enigma-parallax' ),
					'pro_url'  => 'https://weblizar.com/themes/enigma-premium/',
					'priority' => 0
				)
			)
		);
